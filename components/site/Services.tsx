...
const CRAFTS: Craft[] = [
  {
    ...
    lead: "One trusted desk for every property need across Vasai, Virar and Nalasopara - and no broker games.",
    body: "1, 2 and 3 BHK flats, plots, shops and bungalows for sale or on rent, matched to your budget and your life. We arrange the site visits, scrutinise every document, and guide you through the home loan, stamp duty and registration from first enquiry to the day the keys are in your hands - with nothing hidden in between.",
  },
  {
    numeral: "II",
    label: "Construction",
    ...
    body: "New construction, civil contracting, interior design and whole-home renovation across Vasai, Virar and Nalasopara. We render the expected result and revise it with you until it is exactly right, then build to that approved vision with quality materials and daily supervision on the site - straight through to handover.",
  },
];
